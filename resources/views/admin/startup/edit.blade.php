...
@section('content')
    ...
    <div class="card">
        <h5 class="card-header">Изменение стартапа</h5>
        <div class="card-body">
            <form id="userForm" method="post" enctype="multipart/form-data" action="{{ route('startup.update', $startup->id) }}">
                @csrf
                ...
                <div class="form-row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="short_desc" id="inputShortDesc" class="form-control">{{ $startup->short_desc }}</textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="inputFullDesc">Описание</label>
                            <textarea name="full_desc" id="inputFullDesc" class="form-control">{{ $startup->full_desc }}</textarea>
                        </div>
                    </div>
                </div>
                <div class="form-row">
