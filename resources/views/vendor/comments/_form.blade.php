<div class="card card-submit-customize">
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('comments.store') }}">
            ...
            @if(isset($guest_commenting) and $guest_commenting == true)
                <div class="form-group">
                    <label for="message">Введите свое имя здесь:</label>
                ...
                <div class="form-group">
                    <label for="message">Введите свой email здесь:</label>
            ...
            <div class="form-group">
                <label for="message">Введите свое сообщение здесь:</label>
            ...
            <button type="submit" class="btn btn-sm btn-outline-success text-uppercase customize-submit-comment-btn">Написать...</button>
        </form>
    </div>
</div>
<br />